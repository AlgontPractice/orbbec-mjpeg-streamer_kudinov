...
def get_config_files():
    ...
    parser.add_argument(
        ...
        type=str,
        default='./orbbec-mjpeg-streamer.json')  # TODO: в проекте есть файл orbbec-mjpeg-streamer.json - его надо положить в папку, указанную тут. При необходимости каталог можно изменить
